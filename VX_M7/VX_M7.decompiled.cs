...
[assembly: AssemblyProduct("VX_M7")]
[assembly: Debuggable(DebuggableAttribute.DebuggingModes.IgnoreSymbolStoreSequencePoints)]
[assembly: AssemblyConfiguration("")]
[assembly: AssemblyDescription("")]
[assembly: AssemblyTitle("NinjaTrader Exported VX_M7")]
...
namespace NinjaTrader.NinjaScript.Indicators
{
	public class Indicator : IndicatorRenderBase
	{
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		public VXM7 VXM7(bool tHE_WALL, bool fORCE_LINES, bool pULLBACKS)
		{
			return null;
		}

		[MethodImpl(MethodImplOptions.NoInlining)]
		public VXM7 VXM7(ISeries<double> input, bool tHE_WALL, bool fORCE_LINES, bool pULLBACKS)
		{
			return null;
		}
...
namespace NinjaTrader.NinjaScript.Indicators._FPLEME_
{
	public class VXM7 : Indicator
	{
		...
		private double renko;

		private double hhv;

		private double llv;

		private Series<double> vma2;

		private double hhv2;

		private double llv2;

		private Series<double> vwap0;

		private double iCumVolume;

		private double iCumTypicalVolume;

		private DateTime lastVWAPCalculationTime;

		private int minutesBetweenVWAPCalculations;
		...
		private Series<double> vx;

		private EMA vxm;

		private Series<double> m0;

		private Series<double> s1;

		private Series<double> s2;

		private Series<double> s3;

		private Series<double> s4;

		private Series<double> s5;

		private Series<double> s6;

		private Series<double> s7;

		private Series<double> s8;

		private Series<double> s9;

		private Series<double> s10;
		...
		private Series<double> i7;

		private Series<double> i8;

		private Series<double> i9;

		private Series<double> i10;

		private Series<double> tw;

		private Series<double> s0_5;

		private Series<double> s1_5;

		private Series<double> s2_5;

		private Series<double> s3_5;

		private Series<double> s4_5;

		private Series<double> s5_5;

		private Series<double> s6_5;

		private Series<double> s7_5;

		private Series<double> s8_5;

		private Series<double> s9_5;

		private Series<double> i0_5;

		private Series<double> i1_5;

		private Series<double> i2_5;

		private Series<double> i3_5;

		private Series<double> i4_5;

		private Series<double> i5_5;

		private Series<double> i6_5;

		private Series<double> i7_5;

		private Series<double> i8_5;

		private Series<double> i9_5;

		private bool twIsRising;
		...
		[NinjaScriptProperty]
		[Display(Name = "THE_WALL", Description = "Mostra THE WALL.", Order = 1, GroupName = "Parameters")]
		public bool THE_WALL { get; set; }

		[NinjaScriptProperty]
		[Display(Name = "FORCE_LINES", Description = "Mostra FORCE LINES", Order = 2, GroupName = "Parameters")]
		public bool FORCE_LINES { get; set; }

		[NinjaScriptProperty]
		[Display(Name = "PULLBACKS", Description = "Mostra linhas de PULL BACK.", Order = 3, GroupName = "Parameters")]
		public bool PULLBACKS { get; set; }

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> M0 => ((NinjaScriptBase)this).Values[0];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S1 => ((NinjaScriptBase)this).Values[1];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S2 => ((NinjaScriptBase)this).Values[2];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S3 => ((NinjaScriptBase)this).Values[3];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S4 => ((NinjaScriptBase)this).Values[4];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S5 => ((NinjaScriptBase)this).Values[5];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S6 => ((NinjaScriptBase)this).Values[6];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S7 => ((NinjaScriptBase)this).Values[7];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S8 => ((NinjaScriptBase)this).Values[8];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S9 => ((NinjaScriptBase)this).Values[9];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S10 => ((NinjaScriptBase)this).Values[10];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I1 => ((NinjaScriptBase)this).Values[21];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I2 => ((NinjaScriptBase)this).Values[22];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I3 => ((NinjaScriptBase)this).Values[23];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I4 => ((NinjaScriptBase)this).Values[24];

		[XmlIgnore]
		[Browsable(false)]
		public Series<double> I5 => ((NinjaScriptBase)this).Values[25];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I6 => ((NinjaScriptBase)this).Values[26];

		[XmlIgnore]
		[Browsable(false)]
		public Series<double> I7 => ((NinjaScriptBase)this).Values[27];

		[XmlIgnore]
		[Browsable(false)]
		public Series<double> I8 => ((NinjaScriptBase)this).Values[28];

		[XmlIgnore]
		[Browsable(false)]
		public Series<double> I9 => ((NinjaScriptBase)this).Values[29];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I10 => ((NinjaScriptBase)this).Values[30];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> TW => ((NinjaScriptBase)this).Values[41];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> TWD => ((NinjaScriptBase)this).Values[42];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> FORCELINE_S => ((NinjaScriptBase)this).Values[43];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PULLBACK_B => ((NinjaScriptBase)this).Values[44];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PULLBACK_S => ((NinjaScriptBase)this).Values[45];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINES_S => ((NinjaScriptBase)this).Values[46];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINES_I => ((NinjaScriptBase)this).Values[47];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S1HL => ((NinjaScriptBase)this).Values[48];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S2HL => ((NinjaScriptBase)this).Values[49];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S3HL => ((NinjaScriptBase)this).Values[50];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S4HL => ((NinjaScriptBase)this).Values[51];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S5HL => ((NinjaScriptBase)this).Values[52];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S6HL => ((NinjaScriptBase)this).Values[53];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S7HL => ((NinjaScriptBase)this).Values[54];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S8HL => ((NinjaScriptBase)this).Values[55];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S9HL => ((NinjaScriptBase)this).Values[56];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S10HL => ((NinjaScriptBase)this).Values[57];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I1HL => ((NinjaScriptBase)this).Values[58];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I2HL => ((NinjaScriptBase)this).Values[59];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I3HL => ((NinjaScriptBase)this).Values[60];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I4HL => ((NinjaScriptBase)this).Values[61];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I5HL => ((NinjaScriptBase)this).Values[62];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I6HL => ((NinjaScriptBase)this).Values[63];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I7HL => ((NinjaScriptBase)this).Values[64];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I8HL => ((NinjaScriptBase)this).Values[65];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I9HL => ((NinjaScriptBase)this).Values[66];

		[XmlIgnore]
		[Browsable(false)]
		public Series<double> I10HL => ((NinjaScriptBase)this).Values[67];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> S1_GUIDE => ((NinjaScriptBase)this).Values[68];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I1_GUIDE => ((NinjaScriptBase)this).Values[69];
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		private void ApplyMapsM75ColoringRules()
		{
		}

		[MethodImpl(MethodImplOptions.NoInlining)]
		private double Normalize(ISeries<double> series, int periodo, double d1, double d2)
		{
			return 0.0;
		}

		[MethodImpl(MethodImplOptions.NoInlining)]
		private double Normalize(Series<double> series, int periodo, double d1, double d2)
		{
			return 0.0;
		}
