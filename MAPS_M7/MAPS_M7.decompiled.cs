...
[assembly: AssemblyProduct("MAPS_M7")]
[assembly: Debuggable(DebuggableAttribute.DebuggingModes.IgnoreSymbolStoreSequencePoints)]
[assembly: AssemblyConfiguration("")]
[assembly: AssemblyDescription("")]
[assembly: AssemblyTitle("NinjaTrader Exported MAPS_M7")]
...
namespace NinjaTrader.NinjaScript.Indicators
{
	public class Indicator : IndicatorRenderBase
	{
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		public MAPS_M7 MAPS_M7(bool cENTRAIS, bool iNTERMEDIARIOS, bool cLEAN_MODE, bool tHE_WALL, bool fORCE_LINES, bool pULLBACKS)
		{
			return null;
		}

		[MethodImpl(MethodImplOptions.NoInlining)]
		public MAPS_M7 MAPS_M7(ISeries<double> input, bool cENTRAIS, bool iNTERMEDIARIOS, bool cLEAN_MODE, bool tHE_WALL, bool fORCE_LINES, bool pULLBACKS)
		{
			return null;
		}
...
{
	public class MAPS_M7 : Indicator
	{
		...
		private Series<double> fp1;

		private Series<double> fp2;

		private Series<double> probs;

		private EMA vxm;

		private Series<double> vxe;

		private Series<double> vx_max;
		...
		[NinjaScriptProperty]
		[Display(Name = "CENTRAIS", Description = "Mostra linhas centrais das MAPS_M7", Order = 1, GroupName = "Parameters")]
		public bool CENTRAIS { get; set; }

		[NinjaScriptProperty]
		[Display(Name = "INTERMEDIARIOS", Description = "Mostra linhas intermediárias das MAPS_M7", Order = 2, GroupName = "Parameters")]
		public bool INTERMEDIARIOS { get; set; }

		[NinjaScriptProperty]
		[Display(Name = "CLEAN_MODE", Description = "Plota extremos apenas quando necessário. ", Order = 3, GroupName = "Parameters")]
		public bool CLEAN_MODE { get; set; }

		[NinjaScriptProperty]
		[Display(Name = "THE_WALL", Description = "Mostra THE WALL.", Order = 4, GroupName = "Parameters")]
		public bool THE_WALL { get; set; }

		[NinjaScriptProperty]
		[Display(Name = "FORCE_LINES", Description = "Mostra FORCE LINES", Order = 5, GroupName = "Parameters")]
		public bool FORCE_LINES { get; set; }

		[NinjaScriptProperty]
		[Display(Name = "PULLBACKS", Description = "Mostra linhas de PULL BACK.", Order = 6, GroupName = "Parameters")]
		...
		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I1 => ((NinjaScriptBase)this).Values[11];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I2 => ((NinjaScriptBase)this).Values[12];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I3 => ((NinjaScriptBase)this).Values[13];

		[XmlIgnore]
		[Browsable(false)]
		public Series<double> I4 => ((NinjaScriptBase)this).Values[14];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I5 => ((NinjaScriptBase)this).Values[15];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I6 => ((NinjaScriptBase)this).Values[16];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I7 => ((NinjaScriptBase)this).Values[17];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I8 => ((NinjaScriptBase)this).Values[18];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I9 => ((NinjaScriptBase)this).Values[19];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> I10 => ((NinjaScriptBase)this).Values[20];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> TW => ((NinjaScriptBase)this).Values[21];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> RANGE_S => ((NinjaScriptBase)this).Values[22];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> RANGE_I => ((NinjaScriptBase)this).Values[23];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> RANGE_U2 => ((NinjaScriptBase)this).Values[24];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> RANGE_D2 => ((NinjaScriptBase)this).Values[25];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINE_S4 => ((NinjaScriptBase)this).Values[26];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINE_S5 => ((NinjaScriptBase)this).Values[27];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINE_S6 => ((NinjaScriptBase)this).Values[28];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINE_S7 => ((NinjaScriptBase)this).Values[29];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINE_S8 => ((NinjaScriptBase)this).Values[30];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINE_S9 => ((NinjaScriptBase)this).Values[31];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINE_S10 => ((NinjaScriptBase)this).Values[32];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINE_I4 => ((NinjaScriptBase)this).Values[33];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINE_I5 => ((NinjaScriptBase)this).Values[34];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINE_I6 => ((NinjaScriptBase)this).Values[35];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINE_I7 => ((NinjaScriptBase)this).Values[36];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINE_I8 => ((NinjaScriptBase)this).Values[37];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINE_I9 => ((NinjaScriptBase)this).Values[38];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> PROBLINE_I10 => ((NinjaScriptBase)this).Values[39];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> RANGE_U3 => ((NinjaScriptBase)this).Values[40];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> RANGE_D3 => ((NinjaScriptBase)this).Values[41];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> RANGE_U4 => ((NinjaScriptBase)this).Values[42];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> RANGE_D4 => ((NinjaScriptBase)this).Values[43];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> RANGE_U5 => ((NinjaScriptBase)this).Values[44];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> RANGE_D5 => ((NinjaScriptBase)this).Values[45];

		[XmlIgnore]
		[Browsable(false)]
		public Series<double> RANGE_U6 => ((NinjaScriptBase)this).Values[46];

		[XmlIgnore]
		[Browsable(false)]
		public Series<double> RANGE_D6 => ((NinjaScriptBase)this).Values[47];
	...
	internal static IntPtr Load()
	{
		lock (typeof(<AgileDotNetRT>))
		{
			...
			try
			{
				...
				if (IntPtr.Size == 4)
				{
					text = "bc45e568-ada6-46ae-b324-fbb7d608b2ef";
					text2 = "AgileDotNetRT";
				}
				else
				{
					text = "a89799b7-74e7-40dd-a97a-86268b88e8a8";
