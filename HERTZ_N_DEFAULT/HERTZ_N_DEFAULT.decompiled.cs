...
[assembly: AssemblyTitle("NinjaTrader Exported HERTZ")]
[assembly: CompilationRelaxations(8)]
[assembly: NeutralResourcesLanguage("en", UltimateResourceFallbackLocation.MainAssembly)]
[assembly: ComVisible(false)]
[assembly: AssemblyProduct("HERTZ")]
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	public class MarketAnalyzerColumn : MarketAnalyzerColumnBase
	{
		...
		public HERTZ HERTZ(ISeries<double> input)
		{
...
namespace NinjaTrader.NinjaScript.Indicators
{
	public class Indicator : IndicatorRenderBase
	{
		...
		public HERTZ HERTZ()
		{
			return HERTZ(((NinjaScriptBase)this).Input);
		}
...
namespace NinjaTrader.NinjaScript.Indicators._FPLEME_
{
	public class HERTZ : Indicator
	{
		...
		private Series<double> hertZ0;

		private SMA hertzSMA;

		private Series<double> hi;

		private Series<double> lo;

		private Series<double> dt;

		[XmlIgnore]
		[Browsable(false)]
		public Series<double> HZ1 => ((NinjaScriptBase)this).Values[0];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> HZ2 => ((NinjaScriptBase)this).Values[1];

		[Browsable(false)]
		[XmlIgnore]
		public Series<double> HZ3 => ((NinjaScriptBase)this).Values[2];

		[XmlIgnore]
		[Browsable(false)]
		public Series<double> HZ4 => ((NinjaScriptBase)this).Values[3];
